module.exports.command = {
    name: "pokedex-toggle-nest",
    aliases: ["ptn"],
    description: "Toggles if a Pokemon in the PokeCloud's Pokedex can nest. Must use the English name.",
    category: "Pokedex",
    usage: "<pokemon>",
    example: "bulbasaur",
...
exports.run = (bot, message, args) => { 
    ...
    let toggle = bot.Pokedex.get(pokedex_english, "nest")
    let Ntoggle = !toggle

    bot.Pokedex.set(pokedex_english, Ntoggle, "nest")
    ...
    var embed = new Discord.RichEmbed()
        ...
        embed.setTitle(pokedex_english + "'s nesting capabilities has been set to " + Ntoggle)
